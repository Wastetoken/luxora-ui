...
const Main = () => {
  ...
  return (
    <div className="relative flex h-full w-screen flex-col items-center justify-center overflow-hidden font-sans text-[#F11313]">
      <motion.ul layout className="mt-25 z-10 flex w-full flex-col items-center justify-center gap-1">
        {list.map((item, index) => (
          <motion.li
            ...
            animate={{
              y: 0,
              opacity: 1,
              height: hoveredIndex === index ? (!isMobile ? 120 : 60) : !isMobile ? 83 : 40,
            }}
            transition={{
              duration: 0.7,
          ...
          >
            <div className="relative flex items-start gap-5">
              <span className="text-[7vw] font-extrabold uppercase leading-[0.8] tracking-[-0.03em]">{item.name}</span>
