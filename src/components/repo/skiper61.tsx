...
const SimpleMouseFollow = () => {
  ...
  return (
    <div
      ...
      className="rounded-4xl bg-background mt-20 size-[500px] cursor-none overflow-hidden bg-white/5 border border-white/10 rounded-3xl"
    >
      <motion.div
        style={{
          x,
...
const SpringMouseFollow = () => {
  ...
  return (
    <div
      ...
      className="rounded-4xl bg-background mt-20 size-[500px] overflow-hidden bg-white/5 border border-white/10 rounded-3xl"
    >
      <motion.div
        style={{
          x: xSpring,
        ...
        className="rounded-full size-10 bg-orange-500"
      ></motion.div>
    </div>
  );
};
...
const Skiper61 = () => {
  return (
    <section className="h-screen w-full snap-y snap-mandatory overflow-y-scroll text-white">
