        ...
        >
          {Array.from({ length: 20 }).map((_, index) => (
            <GridShowRandom
              ...
              imgSrc={`/images/lummi/img${index + 1}.png`}
...
const WithGsap = ({ className }: { className?: string }) => {
  ...
  const images = [
    "/images/lummi/illstration1.png",
    "/images/lummi/illstration2.png",
    "/images/lummi/illstration3.png",
    "/images/lummi/illstration4.png",
    "/images/lummi/illstration5.png",
    "/images/lummi/illstration6.png",
    "/images/lummi/illstration7.png",
    "/images/lummi/illstration8.png",
    "/images/lummi/illstration9.png",
    "/images/lummi/illstration10.png",
    "/images/lummi/illstration11.png",
    "/images/lummi/illstration12.png",
    "/images/lummi/illstration13.png",
    "/images/lummi/illstration14.png",
    "/images/lummi/illstration15.png",
    "/images/lummi/illstration16.png",
    "/images/lummi/illstration17.png",
    "/images/lummi/img25.png",
    "/images/lummi/img26.png",
