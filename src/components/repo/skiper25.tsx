...
const Skiper25 = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center relative min-h-[400px]">
      <div className="text-foreground absolute top-[20%] grid content-start justify-items-center gap-6 py-20 text-center text-white">
...
export const MusicToggleButton = () => {
  ...
  // You might want to replace this with a valid audio file path for your project
  ...
  return (
    <>
      <motion.div
        ...
        className="bg-white cursor-pointer rounded-full p-2 mt-20"
      >
        <motion.div
        ...
        >
          ...
          {heights.map((height, index) => (
            <motion.div
              key={index}
              className="bg-black w-[1px] rounded-full"
              initial={{ height: 1 }}
              animate={{
