  ...
  return (
    ...
    >
      <style>{`
        ...
        .grid-line { stroke: rgba(200,180,160,0.08); stroke-width: 0.5; }
        .detail-dot { fill: ${colors[200]}; opacity: 0.3; }
        .corner-element { position: absolute; width: 16px; height: 16px; border: 1px solid rgba(200,180,160,0.2); }
        .floating-element {
          position: absolute; width: 6px; height: 6px; background: ${colors[300]};
          border-radius: 50%; opacity: 0.2; animation: float 10s infinite ease-in-out paused;
        }
        @keyframes float {
