...
const Skiper4 = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-5 relative">
      <motion.div
...
const Options = ({
  ...
  return (
    <motion.div
      className="border-white/10 bg-black/50 absolute top-4 right-4 flex w-[245px] flex-col gap-3 rounded-3xl border p-3 backdrop-blur-sm z-50"
      drag={isDragging}
      dragMomentum={false}
    >
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between py-1">
          <p className="text-sm opacity-50 text-white">Scale </p>
          <input
            type="range"
            min={0}
            max={100}
            ...
            className="h-1.5 w-[120px] cursor-pointer appearance-none rounded-lg bg-white/20"
          />
        </div>
        <div className="flex items-center justify-between py-1">
          <p className="text-sm opacity-50 text-white">Gap </p>
          <input
            type="range"
            min={0}
            max={100}
        ...
        <div className="mt-1 flex items-center justify-between py-1">
          <p className="text-sm opacity-50 text-white">Flex </p>
          <div className="flex items-center justify-end gap-2">
            <button
              className="cursor-pointer text-sm opacity-50 hover:opacity-100 text-white"
