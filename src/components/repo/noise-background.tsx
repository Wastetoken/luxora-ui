...
// Builder wrapper
export default function NoiseBackgroundWrapper() {
  return (
    <div className="flex items-center justify-center p-8">
      <NoiseBackground containerClassName="w-full max-w-md p-8">
        <h3 className="text-lg font-bold text-neutral-900 dark:text-white">Noise Background</h3>
        <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400">A dynamic animated gradient background with noise overlay.</p>
      </NoiseBackground>
    </div>
  );
}
